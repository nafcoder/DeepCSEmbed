...
f = open("./output_csvs/CAT_SMOTE.csv", "w", newline="")
writer = csv.writer(f)
...
writer.writerow([f'CAT_SMOTE',f'{prec:.3f}', f'{f1_score_1:.3f}', f'{auPR:.3f}', f'{acc:.3f}', f'{specificity:.3f}', f'{mcc:.3f}', f'{sensitivity:.3f}', f'{auc:.3f}', f'{bal_acc:.3f}'])
